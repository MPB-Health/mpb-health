...
/** Validates AOS path tenant before rendering the advisor shell. */
export function AosTenantGate({ children }: { children: React.ReactNode }) {
...
/** Redirect aos.aryxcloud.com root to platform landing. */
export function AosPlatformHome() {
