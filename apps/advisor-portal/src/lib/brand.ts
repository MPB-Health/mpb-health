// Hostname-aware brand switching for the advisor-portal app.
//
// Today: advisor.aryxcloud.com → ARYX brand; everything else
// (advisor.mpb.health, localhost, preview URLs) → MPB Health brand.
//
...
const MPB_LOGO       = '/assets/MPB-Health-No-background.png';
