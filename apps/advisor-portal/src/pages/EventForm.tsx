  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center gap-4 mb-8">
        <button onClick={() => navigate('/events/manage')} className="p-2 text-neutral-400 hover:text-neutral-700 rounded-lg transition-colors">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-sm"
                placeholder="event-url-slug"
              />
              <p className="text-xs text-neutral-400 mt-1">URL: mpb.health/events/{form.slug || '...'}</p>
            </div>
        ...
        <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700 mb-1">Location Type</label>
              <select
        ...
        <div className="bg-white border border-neutral-200 rounded-lg p-6 space-y-4">
          <h2 className="text-lg font-semibold text-neutral-900">Featured Image</h2>
          <ImageUploader
          ...
          <div className="flex flex-wrap gap-6">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-400">Visible on the public website</p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-400">Highlighted on the homepage</p>
              </div>
            </label>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between pt-2 pb-8">
          <button
            type="button" onClick={() => navigate('/events/manage')}
            className="px-4 py-2.5 text-sm font-medium text-neutral-700 hover:bg-neutral-100 rounded-lg transition-colors"
          >
            Cancel
          </button>
          <button
