...
const fallbackPlans: PlanWithFeatures[] = [
  {
    ...
    slug: 'essentials',
    name: 'Essentials',
    tagline: 'Virtual care access and basic protection for healthy individuals',
  ...
  },
  {
    ...
    slug: 'mec-essentials',
    name: 'MEC+ Essentials',
    tagline: 'Minimum Essential Coverage with virtual care and preventive benefits',
  ...
  },
  {
    ...
    slug: 'care-plus',
    name: 'Care Plus',
    tagline: 'Comprehensive sharing with virtual care for unexpected expenses',
