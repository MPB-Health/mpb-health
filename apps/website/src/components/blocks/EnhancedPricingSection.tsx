...
const plansData: PlanData[] = [
  {
    ...
    planId: 'essentials',
    price: '$50',
    description: 'Perfect for healthy individuals who want virtual care access and basic protection.',
  ...
  },
  {
    ...
    planId: 'care-plus',
    price: '$166',
    description: 'Comprehensive sharing with virtual care and support for unexpected medical expenses.',
