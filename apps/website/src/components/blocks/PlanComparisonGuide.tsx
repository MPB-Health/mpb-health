...
const comparisonData: ComparisonCategory[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      {
        feature: 'Mammogram, Colonoscopy',
        carePlus: false,
        direct: '6-mo wait (screening)',
        essentials: false,
      },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 bg-neutral-50 rounded-xl p-6">
          ...
          <ul className="space-y-2 text-sm text-neutral-700">
            ...
            <li><strong>Initial Unshareable Amount (IUA):</strong> This is the amount you pay before sharing begins for each medical need (Care+ and Direct). Essentials does not include medical cost sharing. Think of the IUA as your personal financial responsibility for sharing memberships.</li>
