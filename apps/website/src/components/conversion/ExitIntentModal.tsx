...
export const ExitIntentModal: React.FC<ExitIntentModalProps> = ({
  ...
  const content = {
    ...
    contact: {
      ...
      description: 'Our advisors are here to help you understand your options and find the perfect membership for your family.',
      cta: 'Schedule a Call',
      ctaLink: '/contact',
      icon: Phone,
    },
    compare: {
      title: 'Compare Memberships Before You Leave',
      subtitle: 'Find Your Perfect Match',
      description: 'See side-by-side comparisons of all memberships with transparent pricing and sharing details.',
