...
export const FORMS: FormEntry[] = [
  ...
  },
  {
    ...
    category: 'employer',
    description: 'Process an employee removal from your MPB Health group membership. Submit this secure employer form to update your organization roster and billing.',
    icon: 'UserMinus',
    estimatedMinutes: 5,
    requiresAuth: false,
  ...
  },
  {
    ...
    category: 'member',
    description: 'Grant permission for MPB Health to discuss your membership details with an authorized family member or representative using this secure authorization form.',
    icon: 'Shield',
    estimatedMinutes: 3,
    requiresAuth: false,
  ...
  },
  {
    ...
    category: 'member',
    description: 'Update your MPB Health membership information online. Change address, dependents, membership details, or account preferences through this secure member form.',
    icon: 'Edit3',
    estimatedMinutes: 7,
    requiresAuth: false,
