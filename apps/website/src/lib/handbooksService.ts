...
const STATIC_HANDBOOKS: HandbookRecord[] = [
  ...
  },
  {
    ...
    pdf_path: '/docs/Premium-HSA-Member-Handbook.pdf',
    plan_type: 'hsa',
    color: 'emerald',
    icon: 'Shield',
  ...
  {
    id: 'static-premium-care',
    slug: 'premium-care',
    name: 'Premium Care Handbook',
    description: 'Premium care membership with enhanced benefits and comprehensive support.',
    pdf_path: '/docs/Premium-Care-Member-Handbook.pdf',
    plan_type: 'family',
    color: 'blue',
    icon: 'Heart',
    features: ['Premium benefits', 'Enhanced care', 'Comprehensive support'],
    is_active: true,
    sort_order: 5,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
