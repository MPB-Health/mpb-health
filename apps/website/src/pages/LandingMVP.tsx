...
function LandingMVP() {
  return (
    <>
      <Helmet>
        <title>MPB Health Sharing Memberships | Save 30-60% on Healthcare</title>
        <meta
          name="description"
        ...
        />
        <meta name="keywords" content="health sharing memberships, affordable healthcare, community health, insurance alternative, medical cost sharing, healthcare savings" />
      </Helmet>
