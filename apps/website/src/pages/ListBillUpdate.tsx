...
const ListBillUpdate = () => {
  ...
  return (
    <>
      <Helmet>
        <title>List-Bill Update | MPB Health</title>
        <meta name="description" content="Update your list-billing information with MPB Health." />
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl sm:text-2xl text-[#0a4c8f]/80 max-w-3xl mx-auto leading-relaxed">
                Update your list-billing information for your organization
              </p>
        ...
        <section className="py-12 sm:py-16 pb-24">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 mb-16">
            <iframe
              ref={iframeRef}
              src="https://www.cognitoforms.com/f/K4Fk3PtQHE-6M-fMiX2fVA/451"
              allow="payment"
              style={{ border: 0, width: '100%', display: 'block', minHeight: '745px' }}
              title="List-Bill Update"
            />
          </div>
        </section>
      </div>
...
export { ListBillUpdate };
export default ListBillUpdate;
