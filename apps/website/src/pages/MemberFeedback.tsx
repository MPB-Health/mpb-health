      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl sm:text-2xl text-[#0a4c8f]/80 max-w-3xl mx-auto leading-relaxed">
                Your feedback helps us improve our services and better serve our members
              </p>
        ...
        <section className="py-12 sm:py-16 pb-24">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 mb-16">
            <iframe
              ref={iframeRef}
              src="https://www.cognitoforms.com/f/K4Fk3PtQHE-6M-fMiX2fVA/425"
              allow="payment"
              style={{ border: 0, width: '100%', display: 'block', minHeight: '685px' }}
