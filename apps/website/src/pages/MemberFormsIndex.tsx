  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        <section className="relative bg-gradient-to-br from-[#0013bd] to-[#1e5a9e] pt-16 pb-24 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl sm:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
                Manage your membership, healthcare needs, and account settings all in one place
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl space-y-12">
            {MEMBER_FORM_CATEGORIES.map((category, idx) => {
              const categoryForms = category.formSlugs
              ...
              return (
                <div key={idx}>
                  <div className="mb-6">
                    <h2 className="text-3xl font-bold text-neutral-900 mb-2">{category.title}</h2>
            ...
            <div className="mt-12 text-center">
              <Card className="inline-block p-6 bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-200">
                ...
                <p className="text-neutral-600 mb-4">
                  Our support team is here to assist you with any questions about member forms.
                </p>
                <Link to="/contact">
