      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#0a4c8f] mb-6 leading-tight">
                Review or Change Health Advisor
              </h1>

              <p className="text-xl sm:text-2xl text-[#0a4c8f]/80 max-w-3xl mx-auto leading-relaxed">
                Update your Health Advisor assignment to ensure you receive the best personalized support
              </p>
        ...
        <section className="py-12 sm:py-16 pb-24">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 mb-16">
            <iframe
              ref={iframeRef}
              src="https://www.cognitoforms.com/f/K4Fk3PtQHE-6M-fMiX2fVA/202"
              style={{ border: 0, width: '100%', display: 'block', minHeight: '1327px' }}
              title="Review or Change Health Advisor Form"
            />
          </div>
        </section>
      </div>
...
export { ReviewOrChangeAdvisor };
export default ReviewOrChangeAdvisor;
