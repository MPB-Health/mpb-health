        ...
        <section className="py-12 sm:py-16 pb-24">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              ...
              <blockquote className="border-l-4 border-[#0013bd] pl-4 italic text-slate-600 my-6">
                <p className="mb-4">
              ...
              <blockquote className="border-l-4 border-[#0013bd] pl-4 text-slate-600 my-6">
              ...
              <p className="text-slate-600 mb-6">
                Please see our full <Link to="/washington-statement" className="text-[#0013bd] hover:underline">Washington statement here</Link>.
              </p>
