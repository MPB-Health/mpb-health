...
const CONTENT_TYPES: ContentType[] = [
  {
    ...
    adminListPath: '/admin/cms/pages',
    adminNewPath: '/admin/cms/pages/new',
  ...
  },
  {
    ...
    icon: FolderOpen,
    table: 'cms_media',
    adminListPath: '/admin/cms/media',
    adminNewPath: '/admin/cms/media',
  ...
  },
  {
    ...
    icon: Layers,
    table: 'cms_templates',
    adminListPath: '/admin/cms/templates',
    adminNewPath: '/admin/cms/templates',
  ...
  },
  {
    ...
    icon: Palette,
    table: 'cms_theme',
    adminListPath: '/admin/cms/theme',
    adminNewPath: '/admin/cms/theme',
  ...
  },
  {
    ...
    icon: FormInput,
    table: 'cms_forms',
    adminListPath: '/admin/cms/forms',
    adminNewPath: '/admin/cms/forms',
  ...
  },
  {
    ...
    icon: MessageSquare,
    table: 'cms_popups',
    adminListPath: '/admin/cms/popups',
    adminNewPath: '/admin/cms/popups',
  ...
  },
  {
    ...
    icon: ArrowRightLeft,
    table: 'cms_redirects',
    adminListPath: '/admin/cms/redirects',
    adminNewPath: '/admin/cms/redirects',
  ...
  },
  {
    ...
    icon: Calendar,
    adminListPath: '/admin/cms/calendar',
    adminNewPath: '/admin/cms/calendar',
  ...
  },
  {
    ...
    icon: Search,
    adminListPath: '/admin/cms/seo',
    adminNewPath: '/admin/cms/seo',
  ...
  },
  {
    ...
    icon: Shield,
    adminListPath: '/admin/cms/permissions',
    adminNewPath: '/admin/cms/permissions',
