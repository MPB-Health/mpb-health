...
**Status:** In progress — steps 1 (Preventative → Preventive), 2 (sharing caps/limits → sharing maximums), 3 (cover/coverage/covered), and 4 (pre-existing → pre-membership) completed August 20, 2026; remaining steps pending.
