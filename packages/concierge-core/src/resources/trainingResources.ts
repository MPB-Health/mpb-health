...
export const TRAINING_RESOURCES: TrainingResource[] = [
  // ─── Health Sharing Introduction & Processes ─────────────────────────
  {
    ...
    links: [
      ...
      {
        label: 'MPB Plans Internal Rules',
        url: '/docs/MPB_Plans_Internal_Rules.pdf',
      },
    ],
    keywords: [
      'sharing request',
  ...
  {
    id: 'mpb-membership-handbook',
    title: 'MPB Flow',
    description: 'Complete handbook for the MPB Flow plan',
  ...
  {
    id: 'mpb-hsa-membership-handbook',
    title: 'MPB Flow HSA',
    description: 'Complete handbook for the MPB Flow HSA plan',
    url: 'https://mpb.health/3d-flip-book/flow-hsa',
    category: 'mpb-plans',
    subcategory: 'Flow HSA',
    type: 'handbook',
    external: true,
    keywords: [
      'MPB Flow HSA',
      'Flow HSA',
      'MPB HSA Membership Handbook',
      'HSA membership handbook',
      'HSA handbook',
      'health savings account',
      'HDHP',
      'HSA HealthShare',
  ...
  {
    id: 'core-healthshare-handbook',
    title: 'Core Healthshare Handbook',
    description: 'Complete handbook for the Core Healthshare plan',
    url: 'https://drive.google.com/file/d/12r3xMHsIT1XoOeRYgj2pobYNcEAf-c7t/view',
    category: 'mpb-plans',
    subcategory: 'Core Healthshare',
    type: 'handbook',
    external: true,
    keywords: [
      'Core Healthshare',
  ...
  {
    id: 'hsa-healthshare-welcome-call',
    title: 'HSA Healthshare Welcome Call',
    description: 'Welcome call script for HSA Healthshare plan members',
    url: 'https://netorg6712533-my.sharepoint.com/:w:/g/personal/julia_mympb_com/IQDoW-KmnP4aSokGEvIU77QKAetEtlU7QiT1_0tV3yc1Nik?e=FX1OIE',
    category: 'welcome-scripts',
    subcategory: 'HSA Healthshare',
    type: 'script',
    external: true,
  ...
  {
    id: 'core-healthshare-welcome-call',
    title: 'Core Healthshare Welcome Call',
    description: 'Welcome call script for Core Healthshare plan members',
    url: 'https://netorg6712533-my.sharepoint.com/:w:/g/personal/julia_mympb_com/IQBYrRcAZ2KORJBFC35AIrfCAVxjhJQ-m_kyK8LmLjAabdE?e=LIiWfn',
    category: 'welcome-scripts',
    subcategory: 'Core Healthshare',
    type: 'script',
    external: true,
  ...
  {
    id: 'flow-welcome-call',
    title: 'MPB Flow Welcome Call',
    description: 'Welcome call script for MPB Flow plan members',
    url: 'https://netorg6712533-my.sharepoint.com/:w:/g/personal/julia_mympb_com/IQAfmi2g_hw5QJjMij8ML38aAbe6UcVF0wgp6UiKkZ8HUPs?e=6n3awX',
    category: 'welcome-scripts',
    subcategory: 'Flow',
    type: 'script',
    external: true,
  ...
  {
    id: 'flow-hsa-welcome-call',
    title: 'MPB Flow HSA Welcome Call',
    description: 'Welcome call script for MPB Flow HSA plan members',
    url: 'https://netorg6712533-my.sharepoint.com/:w:/g/personal/julia_mympb_com/IQC5W3hCbCV7Ta7vmtaJardYATKkH2eo1pNS15Ks01LLjcQ?e=kBdfS1',
    category: 'welcome-scripts',
    subcategory: 'Flow HSA',
    type: 'script',
    external: true,
  ...
  },
  {
    ...
    description: 'Summary of Benefits and Coverage for the ARM Atlantic Risk HSA High Deductible Health Plan (2026)',
    url: '/docs/ARM-HDHP-Plan-SBC-2026.pdf',
    category: 'telehealth',
    subcategory: 'ARM',
    type: 'pdf',
    external: true,
    keywords: ['SBC', 'summary of benefits', 'HDHP', 'high deductible', 'deductible', 'out of pocket maximum', 'copay', 'coinsurance', 'preventive', 'emergency', 'hospitalization', 'prescription', 'specialist', '2026', 'Atlantic Risk', 'Atlantic Risk HSA', 'HSA'],
  },
  {
  ...
  },
  {
    ...
    url: '/docs/ARM-Welcome-Letter-2026.pdf',
    category: 'telehealth',
    subcategory: 'ARM',
    type: 'pdf',
    external: true,
