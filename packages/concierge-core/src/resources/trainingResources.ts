...
export const TRAINING_RESOURCES: TrainingResource[] = [
  ...
  },
  {
    ...
    description: 'Proof of sharing reference for SAVVOS and Sedera (hosted in concierge documents).',
    url: '/docs/Proof%20of%20sharing.pdf',
    category: 'health-sharing',
    type: 'pdf',
    external: true,
    keywords: [
  ...
  },
  {
    ...
    title: 'MCS Resources',
    description:
      'Member care systems quick links: Zion HealthShare FAQ and SAVVOS & Sedera reference (PDF).',
  ...
  },
  {
    ...
    description: 'Proof of coverage letter template for ARM plan members (Word document)',
    url: '/docs/ARM%20Proof%20of%20Coverage%20Letter.docx',
    category: 'telehealth',
    subcategory: 'ARM',
    type: 'document',
    external: true,
