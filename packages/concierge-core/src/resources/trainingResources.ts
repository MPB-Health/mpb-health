...
export const TRAINING_RESOURCES: TrainingResource[] = [
  ...
  },
  {
    ...
    title: 'MPB Membership Handbook',
    description: 'Complete MPB membership handbook for healthshare plans',
    url: '/docs/MPB_Membership_Handbook.pdf',
    category: 'mpb-plans',
    type: 'handbook',
    external: false,
    keywords: [
  ...
  },
  {
    ...
    title: 'MPB HSA Membership Handbook',
    description: 'Complete MPB HSA membership handbook',
    url: '/docs/MPB_HSA_Membership_Handbook.pdf',
    category: 'mpb-plans',
    subcategory: 'HSA',
    type: 'handbook',
    external: false,
