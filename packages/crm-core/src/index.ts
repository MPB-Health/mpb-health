...
// Note: Not using 'export * from ./vendors' - explicit exports above to avoid conflicts
...
// Note: Not using 'export * from ./purchase-orders' to avoid ApprovalStatus conflict
...
// Note: Not using 'export * from ./sales-orders' to avoid ApprovalStatus conflict
