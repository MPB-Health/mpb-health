...
SELECT
    ...
    CASE p.role
        ...
        WHEN 'staff' THEN 'staff'::user_role_type
        WHEN 'advisor' THEN 'advisor'::user_role_type
        WHEN 'guest' THEN 'guest'::user_role_type
        ELSE 'member'::user_role_type
    END as role
FROM profiles p
WHERE NOT EXISTS (
