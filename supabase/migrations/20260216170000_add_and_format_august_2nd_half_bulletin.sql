...
<h2 style="font-size: 24px; font-weight: 700; color: #000000; margin: 32px 0 16px 0; line-height: 1.3;">MPB Health App Demo Recording</h2>

<p style="font-size: 16px; line-height: 1.7; color: #334155; margin: 0 0 12px 0;">Advisors are encouraged to report any app glitches or feedback by submitting a tkt.</p>

<p style="margin: 0 0 16px 0;"><a href="https://mympb.zohodesk.com/portal/en/signin" target="_blank" style="display: inline-block; padding: 12px 28px; background-color: #2563eb; color: #ffffff; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px;">Submit a TKT</a></p>

<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; margin: 24px 0; border-radius: 12px;">
  <iframe src="https://player.vimeo.com/video/1114015454?dnt=1&app_id=122963" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none; border-radius: 12px;" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media" allowfullscreen></iframe>
</div>
...
<p style="font-size: 16px; line-height: 1.7; color: #334155; margin: 0 0 12px 0;">The contest is heating up!</p>

<p style="font-size: 16px; line-height: 1.7; color: #334155; margin: 0 0 12px 0;"><strong style="color: #111827;">Goal:</strong> 60 enrollments with a January 1st effective date (cancellations will be deducted).</p>

<p style="font-size: 16px; line-height: 1.7; color: #334155; margin: 0 0 12px 0;"><strong style="color: #111827;">Current Leaders:</strong></p>
<ol style="margin: 0 0 16px 0; padding-left: 24px;">
  <li style="font-size: 16px; line-height: 1.7; color: #334155; margin-bottom: 6px;">Christine</li>
  <li style="font-size: 16px; line-height: 1.7; color: #334155; margin-bottom: 6px;">Lou</li>
  <li style="font-size: 16px; line-height: 1.7; color: #334155; margin-bottom: 6px;">Misty</li>
  <li style="font-size: 16px; line-height: 1.7; color: #334155; margin-bottom: 6px;">Leslie</li>
</ol>

<p style="font-size: 16px; line-height: 1.7; color: #334155; margin: 0 0 12px 0;">Numbers are being updated regularly and shared with Zion and Planstin for verification.</p>
...
<p style="font-size: 16px; line-height: 1.7; color: #334155; margin: 0 0 12px 0;">Powered by Planstin &amp; Zion Healthshare</p>

<p style="margin: 0 0 16px 0;"><a href="https://advisor.mpb.health/zion-healthshare-contest/" target="_blank" style="display: inline-block; padding: 12px 28px; background-color: #2563eb; color: #ffffff; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px;">Learn More</a></p>
',
  'bulletin',
