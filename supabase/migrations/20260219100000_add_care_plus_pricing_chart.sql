...
VALUES (
  ...
  'https://dtmnkzllidaiqyheguhl.supabase.co/storage/v1/object/public/advisor-documents/care-plus-pricing-thumbnail%20(1).png',
  '1.0',
  true,
  true,
  0,
...
VALUES (
  ...
  'https://dtmnkzllidaiqyheguhl.supabase.co/storage/v1/object/public/advisor-documents/secure-hsa-pricing-thumbnail%20(1).png',
  '1.0',
  true,
  true,
  0,
...
VALUES (
  ...
  'https://dtmnkzllidaiqyheguhl.supabase.co/storage/v1/object/public/advisor-documents/direct-pricing-thumbnail%20(1).png',
  '1.0',
  true,
  true,
  0,
