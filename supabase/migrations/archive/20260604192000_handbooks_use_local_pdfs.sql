...
-- Google Drive iframe previews break clickable links (Sedera guidelines, provider
-- search, RX tier PDFs) and interactive elements. Local /docs/ paths use the
-- browser's native PDF viewer with working hyperlinks.
